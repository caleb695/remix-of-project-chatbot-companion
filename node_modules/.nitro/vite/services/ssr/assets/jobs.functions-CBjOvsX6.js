import { t as ghFetch } from "./github.server-liDhNs7u.js";
import { m as getRequest, t as createServerFn } from "./createServerFn-BFFE07zL.js";
...
async function refreshRunnerIfStale(args) {
	const { WORKFLOW_YML, RUNNER_MJS, RUNNER_VERSION } = await import("./workflow-template.server-B3YexB9K.js");
...
var installCoderWorkflow = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).validator((i) => z.object({ repoId: z.string().uuid() }).parse(i)).handler(installCoderWorkflow_createServerFn_handler, async ({ context, data }) => {
	...
	const { WORKFLOW_YML, RUNNER_MJS } = await import("./workflow-template.server-B3YexB9K.js");
...
var enqueueCodingJob = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).validator((i) => z.object({
...
var getJob = createServerFn({ method: "GET" }).middleware([requireSupabaseAuth]).validator((i) => z.object({ id: z.string().uuid() }).parse(i)).handler(getJob_createServerFn_handler, async ({ context, data }) => {
...
var getJobDiff = createServerFn({ method: "GET" }).middleware([requireSupabaseAuth]).validator((i) => z.object({ id: z.string().uuid() }).parse(i)).handler(getJobDiff_createServerFn_handler, async ({ context, data }) => {
...
var approveJob = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).validator((i) => z.object({ id: z.string().uuid() }).parse(i)).handler(approveJob_createServerFn_handler, async ({ context, data }) => {
...
var discardJob = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).validator((i) => z.object({ id: z.string().uuid() }).parse(i)).handler(discardJob_createServerFn_handler, async ({ context, data }) => {
...
var listJobsForThread = createServerFn({ method: "GET" }).middleware([requireSupabaseAuth]).validator((i) => z.object({ threadId: z.string().uuid() }).parse(i)).handler(listJobsForThread_createServerFn_handler, async ({ context, data }) => {
...
var cancelJob = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).validator((i) => z.object({ id: z.string().uuid() }).parse(i)).handler(cancelJob_createServerFn_handler, async ({ context, data }) => {
	await context.supabase.from("coding_jobs").update({
		status: "failed",
...
var enqueueIndexJob = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).validator((i) => z.object({
...
var getLatestIndexJob = createServerFn({ method: "GET" }).middleware([requireSupabaseAuth]).validator((i) => z.object({ repoId: z.string().uuid() }).parse(i)).handler(getLatestIndexJob_createServerFn_handler, async ({ context, data }) => {
