...
import { z } from "zod";
//#region src/lib/github.functions.ts?tss-serverfn-split
...
var startGithubOAuth = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).handler(startGithubOAuth_createServerFn_handler, async ({ context }) => {
	...
	const { signState } = await import("./oauth-state.server-MOpra_96.js");
...
var listUserRepos = createServerFn({ method: "GET" }).middleware([requireSupabaseAuth]).handler(listUserRepos_createServerFn_handler, async ({ context }) => {
	...
	const { listAllRepos } = await import("./github.server-liDhNs7u.js").then((n) => n.n);
...
var addRepoSelection = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).validator((input) => z.object({
...
var getRepoSelection = createServerFn({ method: "GET" }).middleware([requireSupabaseAuth]).validator((input) => z.object({ id: z.string().uuid() }).parse(input)).handler(getRepoSelection_createServerFn_handler, async ({ context, data }) => {
...
var removeRepoSelection = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).validator((input) => z.object({ id: z.string().uuid() }).parse(input)).handler(removeRepoSelection_createServerFn_handler, async ({ context, data }) => {
...
var syncRepoFromGithub = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).validator((input) => z.object({ repoId: z.string().uuid() }).parse(input)).handler(syncRepoFromGithub_createServerFn_handler, async ({ context, data }) => {
	...
	const { pullRepoFiles } = await import("./github.server-liDhNs7u.js").then((n) => n.n);
...
var commitAndPush = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).validator((input) => z.object({
	...
	const { commitChanges } = await import("./github.server-liDhNs7u.js").then((n) => n.n);
...
var listWorkingFiles = createServerFn({ method: "GET" }).middleware([requireSupabaseAuth]).validator((input) => z.object({ repoId: z.string().uuid() }).parse(input)).handler(listWorkingFiles_createServerFn_handler, async ({ context, data }) => {
...
var getWorkingFile = createServerFn({ method: "GET" }).middleware([requireSupabaseAuth]).validator((input) => z.object({
	repoId: z.string().uuid(),
	path: z.string()
