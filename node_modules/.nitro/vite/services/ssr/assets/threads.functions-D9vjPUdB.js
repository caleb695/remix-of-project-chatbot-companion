...
var createThread = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).validator((input) => z.object({
...
var deleteThread = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).validator((input) => z.object({ id: z.string().uuid() }).parse(input)).handler(deleteThread_createServerFn_handler, async ({ context, data }) => {
...
var getThreadMessages = createServerFn({ method: "GET" }).middleware([requireSupabaseAuth]).validator((input) => z.object({ threadId: z.string().uuid() }).parse(input)).handler(getThreadMessages_createServerFn_handler, async ({ context, data }) => {
...
var renameThread = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).validator((input) => z.object({
	id: z.string().uuid(),
...
var getThread = createServerFn({ method: "GET" }).middleware([requireSupabaseAuth]).validator((input) => z.object({ id: z.string().uuid() }).parse(input)).handler(getThread_createServerFn_handler, async ({ context, data }) => {
...
var updateThread = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).validator((input) => z.object({
	id: z.string().uuid(),
	model: z.string().optional(),
