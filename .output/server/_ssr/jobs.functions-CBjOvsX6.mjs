...
//#region node_modules/.nitro/vite/services/ssr/assets/jobs.functions-CBjOvsX6.js
...
var installCoderWorkflow = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).validator((i) => objectType({ repoId: stringType().uuid() }).parse(i)).handler(installCoderWorkflow_createServerFn_handler, async ({ context, data }) => {
...
var getJob = createServerFn({ method: "GET" }).middleware([requireSupabaseAuth]).validator((i) => objectType({ id: stringType().uuid() }).parse(i)).handler(getJob_createServerFn_handler, async ({ context, data }) => {
...
var getJobDiff = createServerFn({ method: "GET" }).middleware([requireSupabaseAuth]).validator((i) => objectType({ id: stringType().uuid() }).parse(i)).handler(getJobDiff_createServerFn_handler, async ({ context, data }) => {
...
var approveJob = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).validator((i) => objectType({ id: stringType().uuid() }).parse(i)).handler(approveJob_createServerFn_handler, async ({ context, data }) => {
...
var discardJob = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).validator((i) => objectType({ id: stringType().uuid() }).parse(i)).handler(discardJob_createServerFn_handler, async ({ context, data }) => {
...
var listJobsForThread = createServerFn({ method: "GET" }).middleware([requireSupabaseAuth]).validator((i) => objectType({ threadId: stringType().uuid() }).parse(i)).handler(listJobsForThread_createServerFn_handler, async ({ context, data }) => {
...
var cancelJob = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).validator((i) => objectType({ id: stringType().uuid() }).parse(i)).handler(cancelJob_createServerFn_handler, async ({ context, data }) => {
	await context.supabase.from("coding_jobs").update({
		status: "failed",
...
var getLatestIndexJob = createServerFn({ method: "GET" }).middleware([requireSupabaseAuth]).validator((i) => objectType({ repoId: stringType().uuid() }).parse(i)).handler(getLatestIndexJob_createServerFn_handler, async ({ context, data }) => {
