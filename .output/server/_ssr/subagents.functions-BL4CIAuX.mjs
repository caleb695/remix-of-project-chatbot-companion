...
//#region node_modules/.nitro/vite/services/ssr/assets/subagents.functions-BL4CIAuX.js
...
var getSubAgents = createServerFn({ method: "GET" }).middleware([requireSupabaseAuth]).inputValidator((i) => objectType({ threadId: stringType().uuid() }).parse(i)).handler(getSubAgents_createServerFn_handler, async ({ context, data }) => {
