...
import { webSearch } from "./agent-tools.server-BuijdZ_Y.mjs";
import { Buffer } from "node:buffer";
//#region node_modules/.nitro/vite/services/ssr/assets/kaggle.server-D2xsopUh.js
...
function kaggleHeaders(username, key) {
	return {
		Authorization: `Basic ${Buffer.from(`${username}:${key}`, "utf8").toString("base64")}`,
